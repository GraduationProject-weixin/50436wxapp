...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1NvtMeFEiw?p=96)
...
## 1.2 课题意义 
现如今，信息种类变得越来越多，信息的容量也变得越来越大，这就是信息时代的标志。近些年，计算机科学发展得也越来越快，而且软件开发技术也越来越成熟，因此，在生活中的各个领域，只要存在信息管理，几乎都有计算机的影子，可以说很多行业都采用计算机的方式管理信息。信息计算机化处理相比手工操作，有着保密性强，效率高，存储空间大，成本低等诸多优点。针对高校教师成果信息管理，采用流浪动物救助小程序可以有效管理，使信息管理能够更加科学和规范。

总之，在实际中使用流浪动物救助小程序，其意义如下：

第一点：流浪动物救助小程序的实际运用，可以帮助管理人员在短时间内完成信息处理工作；
...
第四点：可以降低信息管理成本；
## 1.3 研究内容
对流浪动物救助小程序设计制作，不仅需要技术支撑，也需要大量的理论研究。本文在对流浪动物救助小程序进行介绍时，将按照如下内容进行。

第一部分：介绍流浪动物救助小程序研究的背景意义，便于用户了解系统；

第二部分：介绍开发流浪动物救助小程序需要搭建的环境，包括技术和工具；

第三部分：介绍用户对流浪动物救助小程序的功能要求，以及对流浪动物救助小程序的性能要求等；
...
### 3.1.2 经济可行性
本系统开发期间需要配置的软件环境，可以免费通过开发类官网下载安装，需要配置的硬件设备也不需要具备很高的性能，通常网吧电脑，或学校计算机机房的电脑都符合要求。因此，从经济方面考虑，流浪动物救助小程序开发可行。
### 3.1.3 操作可行性
流浪动物救助小程序根据用户使用习惯进行开发，设计的界面具有统一性，并具备优秀的导航功能。所以，只要会简单操作电脑的人员，可以无压力操作流浪动物救助小程序。
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|chongwu\_name|String|寻宠标题|是|
|3|chongwu\_photo|String|寻宠照片|是|
|4|chongwu\_address|String|位置|是|
|5|zan\_number|Integer|赞|是|
|6|cai\_number|Integer|踩|是|
|7|chongwu\_types|Integer|寻宠类型|是|
|8|chongwu\_clicknum|Integer|寻宠热度|是|
|9|chongwu\_content|String|寻宠介绍|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|dongwu\_name|String|求助名称|是|
|3|dongwu\_photo|String|求助照片|是|
|4|dongwu\_types|Integer|求助类型|是|
|5|yonghu\_id|Integer|用户|是|
|6|dongwu\_clicknum|Integer|求助热度|是|
|7|dongwu\_content|String|求助详情|是|
|8|qiuzhuzhuangtai\_types|Integer|求助状态|是|
|9|dongwu\_delete|Integer|逻辑删除|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|dongwu\_id|Integer|求助|是|
|3|yonghu\_id|Integer|用户|是|
|4|dongwu\_collection\_types|Integer|类型|是|
|5|insert\_time|Date|收藏时间|是|
|6|create\_time|Date|创建时间|是|
表4.7求助留言表
...
|2|dongwu\_id|Integer|求助|是|
|3|yonghu\_id|Integer|用户|是|
|4|dongwu\_liuyan\_text|String|留言内容|是|
|5|insert\_time|Date|留言时间|是|
|6|reply\_text|String|回复内容|是|
|7|update\_time|Date|回复时间|是|
|8|create\_time|Date|创建时间|是|
...
|2|dongwu\_id|Integer|求助|是|
|3|yonghu\_id|Integer|用户|是|
|4|dongwu\_yuyue\_text|String|领养缘由|是|
|5|dongwu\_yuyue\_yesno\_types|Integer|审核状态|是|
|6|dongwu\_yuyue\_yesno\_text|String|审核回复|是|
...
![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\动物求助.jpg](/md/blog.008.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\动物求助.jpg")
动物求助实体属性图

（4）下图是求助留言实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\求助留言.jpg](/md/blog.009.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\求助留言.jpg")
求助留言实体属性图

（5）下图是求助报名实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\求助报名.jpg](/md/blog.010.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\求助报名.jpg")
求助报名实体属性图
...
![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\求助收藏.jpg](/md/blog.012.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\求助收藏.jpg")
求助收藏实体属性图

（8）下图是寻宠收藏实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\寻宠收藏.jpg](/md/blog.013.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\寻宠收藏.jpg")
寻宠收藏实体属性图

（9）下图是寻宠留言实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\寻宠留言.jpg](/md/blog.014.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\寻宠留言.jpg")
寻宠留言实体属性图

（10）下图是寻宠实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\寻宠.jpg](/md/blog.015.jpeg "C:/Users/Administrator/Desktop/temp111\1\\_\_\_\_img\寻宠.jpg")
寻宠实体属性图
# 第5章 系统实现
...
图5.1 用户信息管理页面
### 5.2 寻宠信息管理
如图5.2显示的就是寻宠信息管理页面，此页面提供给管理员的功能有：查看已发布的寻宠信息数据，修改寻宠信息，寻宠信息作废，即可删除，还进行了对寻宠信息名称的模糊查询 寻宠信息信息的类型查询等等一些条件。
...
图5.2 寻宠信息管理页面
### 5.3动物求助管理
如图5.3显示的就是动物求助管理页面，此页面提供给管理员的功能有：根据动物求助进行条件查询，还可以对动物求助进行新增、修改、查询操作等等。
